			...
			<div>
				{isEditing ? (
					<div className="task-container">
						...
						/>
						<span className="add-button-edit" onClick={changeTodo}>
							Add
						</span>
					</div>
				) : (
					<div className="task-container">
						...
						<FontAwesomeIcon className='close' icon={faPenSquare} onClick={() => setIsEditing(true) }/>
						<FontAwesomeIcon className='close' icon={faTrash} onClick={deleteTodo} />
					</div>
				)}
			</div>
		</li>
